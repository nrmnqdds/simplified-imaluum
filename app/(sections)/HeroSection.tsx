      ...
      <div className="mx-auto max-w-7xl px-6 pb-24 pt-10 sm:pb-32 lg:flex lg:px-8 lg:py-40">
        <div className="mx-auto max-w-2xl flex-shrink-0 lg:mx-0 lg:max-w-xl lg:pt-8">
          ...
          <div className="mt-24 sm:mt-32 lg:mt-16">
            <span className="mr-2 rounded-full bg-yellow-500/10 px-3 py-2 text-sm font-semibold leading-6 text-yellow-400 ring-1 ring-inset ring-indigo-500/20">
              In construction
            </span>
            <Link
          ...
          <div className="mt-10 flex items-center gap-x-6">
            <button
              ...
              className="rounded-md dark:bg-cyan-500 bg-cyan-600 px-3.5 py-2.5 text-sm font-semibold text-slate-200 shadow-sm hover:bg-cyan-700 dark:hover:bg-cyan-600 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-cyan-400 dark:focus-visible:outline-cyan-300"
            >
              Log In
            </button>
            <Link
